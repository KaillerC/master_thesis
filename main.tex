...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % 中文封面内容
  \title{中国科学技术大学\\硕士毕业论文\\示例文档(Beta)}%一般情况下扉页和封皮、书脊共用一个标题文本，可以不用定义\spinetitle（仅硕博有用）, \covertitle（本硕博均有用）和\encovertitle（仅本科有用）。特殊情况见下。
  ...
  \author{陈\ 凯}
  \depart{6系}%系别，硕博请用系代号，本科请用全称如
  %\depart{数理化和信息工程系}
  \major{电子与通信工程}%专业，硕博请用全称，本科不需要
  \advisor{方璐\ 副教授}
  \coadvisor{}%第二导师，没有请注释掉
  \studentid{SA13006902}%For bachelor only
  \submitdate{二〇一六年三月}
